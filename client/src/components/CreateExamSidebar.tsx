...
const ExamDetails = () => {
  return (
    <div className="w-full font-semibold border-b-1 cursor-pointer hover:bg-slate-200 rounded-md border-slate-300 p-4">
      <span className="flex items-center justify-between">
        Exam Details <RiArrowRightLine />
      </span>
    </div>
  );
};
const ListItem = () => {
  return (
    <div className="relative flex flex-col rounded-lg bg-white cursor-pointer  border-b-1 border-slate-200">
...
const CreateExamSidebar: React.FC<{
  questions: Question[];
  setQeustions: React.Dispatch<React.SetStateAction<Question[]>>;
